...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Viewport
    ref={ref}
    className={cn(
      'fixed z-[100] flex max-h-screen w-[calc(100%-2rem)] max-w-sm flex-col gap-2 outline-none bottom-20 right-4 left-4 sm:left-auto sm:top-4 sm:bottom-auto pb-safe',
      className,
    )}
    {...props}
  />

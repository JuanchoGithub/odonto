...
export const BUILTIN_TEMPLATES: WhatsappTemplate[] = [
  ...
  },
  {
    ...
    body_es:
      'Hola {{name}}, hoy {{weekday}} tenía un turno a las {{time}}, pero no se presentó, ¿podría confirmar si no va a venir? Gracias.',
    body_en:
      'Hi {{name}}, today {{weekday}} you had an appointment at {{time}}, but you did not show up. Could you confirm whether you are still coming? Thank you.',
    applies_to: 'past',
    enabled: 1,
  },
];
